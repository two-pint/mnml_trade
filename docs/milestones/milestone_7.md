# Milestone 7 — Polish & Scale: Tickets
...
## M7-001: Redis cache (optional multi-node)
...
## M7-002: Web performance optimization
...
### Description (why this ticket is needed)
The PRD targets < 2s page load. As features have been added across M2–M6, bundle size and render paths may have grown. This ticket audits and optimizes: proper RSC/client component boundaries, code splitting, lazy-loaded tabs, image optimization, and Suspense boundaries for progressive loading.
...
## M7-004: Error boundaries and error pages (web)
...
## M7-005: Mobile — app store assets and configuration
...
## M7-006: Mobile — crash reporting and analytics
...
## M7-007: Mobile — App Store and Play Store submission
...
## M7-008: Observability — monitoring and health
...
## M7-009: Oban tuning and job reliability
...
## M7-010: Advanced features (optional scope)
...
- [ ] M7-001: Redis cache (if multi-node)
- [ ] M7-002: Web performance optimization
- [ ] M7-003: SEO and metadata
- [ ] M7-004: Error boundaries and error pages
- [ ] M7-005: Mobile — store assets and config
- [ ] M7-006: Mobile — crash reporting and analytics
- [ ] M7-007: Mobile — App Store and Play Store submission
- [ ] M7-008: Observability — monitoring and health
- [ ] M7-009: Oban tuning and job reliability
- [ ] M7-010: Advanced features (optional)
