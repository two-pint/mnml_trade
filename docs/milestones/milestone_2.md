...
**Done when**: Users can search stocks, view overview and Technical Analysis tab with chart, indicators, and score on both web and mobile; basic institutional data (options flow, dark pool) is visible; all data is cached per TTL.
