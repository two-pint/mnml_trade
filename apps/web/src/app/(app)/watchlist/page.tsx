    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      ...
      {items.length === 0 ? (
        <div className="rounded-xl border border-gray-200 bg-white p-12 text-center shadow-sm">
          ...
          <h2 className="text-lg font-semibold text-gray-900">No stocks in your watchlist</h2>
                ...
                >
                  ...
                  <td className="px-4 py-3 text-right">
                    <button
                      ...
                      className="text-sm text-gray-400 transition-colors hover:text-bearish disabled:opacity-50"
                    >
      ...
      {history.length > 0 && (
        <section className="mt-10">
          <h2 className="mb-4 text-lg font-semibold text-gray-900">Recently viewed</h2>
